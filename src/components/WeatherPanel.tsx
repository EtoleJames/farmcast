  ...
  return (
    <section>
      <div style={{ marginBottom: "24px" }}>
        <p style={{ fontSize: "12px", fontWeight: 700, letterSpacing: "0.08em", textTransform: "uppercase", color: "var(--text-muted)", marginBottom: "4px" }}>
          7-Day Forecast
        </p>
        <h2 style={{ fontSize: "22px", fontWeight: 700, color: "var(--text-primary)" }}>
          {location.name},{" "}
          <span style={{ color: "var(--accent-green)", fontWeight: 400 }}>{location.country}</span>
        </h2>
      </div>
